const CASE_STUDIES = [
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/akrdesign/image/upload/v1730113457/growthios/navi-mumbai/main-image.webp',
    isFeatured: true,
    content: {
      mainHeading: {
        heading: "How Growthios Boosted a Navi Mumbai Realtor's Revenue to ₹11.10 CR in Just 1 Month",
        image: `https://res.cloudinary.com/akrdesign/image/upload/v1730113457/growthios/navi-mumbai/main-image.webp`,
      },
      agenda: {
        heading: "Agenda",
      ...
      introduction: {
        heading: "Introduction",
        content: "Growthios proudly presents a transformative digital journey we undertook with a Navi Mumbai realtor. Facing challenges with insufficient lead generation, this client had been generating leads online but wasn't getting consistent leads so here's how Growthios entered",
        image: `https://res.cloudinary.com/${process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME}/image/upload/v1729334775/growthios/klog-reality-solutions/introduction.webp`
      },
      clientOverview: {
        heading: "Client Overview",
        content: "Our client, Mr.Rupesh Pawar an experienced real estate professional with over 3 years in the industry, hails from Navi Mumbai His portfolio primarily includes 2BHK to 4BHK apartments,he runs a firm called lease for you which is sole selling real estate firm",
      ...
      clientChallenges: {
        ...
        content: [
          {
            point: 'Cost per lead was high above a 300 ₹'
          },
          {
            point: "He wasn't meeting his sales target at all"
          },
          {
            point: "Insufficient site vists for the project."
          }
        ],
        image: `https://res.cloudinary.com/akrdesign/image/upload/v1730113797/growthios/navi-mumbai/challenge.webp`
      },
      joinedHand: {
        heading: "How We Joined Hands",
        content: "Our consistent and informative content about real estate marketing on Instagram caught his attention. He reached out for support in online marketing, and Growthios was ready to deliver",
        image: '/images/home-about.webp'
      },
      strategy: {
        heading: "Growthios' Winning Strategy",
        content: "We zoomed in on Facebook Ads, an efficient and cost-effective solution for precise audience targeting. We created compelling ads with Persuasive copies .and set-up lead magnet as well .",
        image: '/images/home-about.webp'
      },
      campaignHighlights: {
        heading: "Campaign Highlights",
        content: [
          {
            point: {
              heading: "Project",
              content: "Midsegmet residential property: 2 & 3 Bhk"
            }
          },
          {
            point: {
          ...
          },
          {
            point: {
              heading: "Targeting",
              content: "Navi Mumbai (50 Mi+ Radius ) 30 - 65 years Gender : Both male and female"
            }
          },
          {
            point: {
              heading: "Ads Placements",
              content: "Advantage+ placements (feeds, stories, reels, search results, and in- stream ads)"
            }
          },
          {
            point: {
              heading: "Audience",
              content: "Individuals working professionals, looking for property, getting married soon, looking for new Home etc"
            }
          },
        ]
      },
      ...
      achievements: {
        heading: "Achievements with Growthios",
        // content: "3 Sales × 58 lakhs (Avg) = 1.75 crores ( 2 Booking got cancelled )",
        image: 'https://res.cloudinary.com/akrdesign/image/upload/v1730205306/growthios/navi-mumbai/achievements.webp'
      },
      success: {
        heading: "Evidence of Success",
        content: "This is Growthios' footprint in the Navi Mumbai Real estate market. With the right digital strategy, we turned leads into a whopping 1.50 Crores. Reduced CPL from 715 to 360 and 530 to 430 ₹ in less than 45 days",
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/akrdesign/image/upload/v1730205706/growthios/bangalore-market/main-image.webp',
    isFeatured: true,
    content: {
      mainHeading: {
        heading: "How Growthios Boosted a Bangalore Realtor's Revenue to ₹4 CR in Just 2 Months",
        image: `https://res.cloudinary.com/akrdesign/image/upload/v1730205706/growthios/bangalore-market/main-image.webp`,
      },
      agenda: {
        heading: "Agenda",
      ...
      introduction: {
        heading: "Introduction",
        content: "Growthios proudly presents a transformative digital journey we undertook with a Bangalore realtor. Facing challenges with lead generation, this client had never ventured into the realm of digital marketing before. Our expertise in funnel creation and Facebook Ads made all the difference",
        image: `https://res.cloudinary.com/${process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME}/image/upload/v1729334775/growthios/klog-reality-solutions/introduction.webp`
      },
      clientOverview: {
        heading: "Client Overview",
      ...
      clientChallenges: {
        ...
        content: [
          {
            point: 'Traditionally, he relied on referrals and conventional lead generation methods. However, the evolving market pushed him to seek qualified online leads'
          },

        ],
        image: `https://res.cloudinary.com/akrdesign/image/upload/v1730206005/growthios/bangalore-market/challenges.webp`
      },
      joinedHand: {
        heading: "How We Joined Hands",
        content: "Our consistent and informative content about real estate marketing on LinkedIn caught his attention. He reached out for support in online marketing, and Growthios was ready to deliver",
        image: '/images/home-about.webp'
      },
      strategy: {
        heading: "Growthios' Winning Strategy",
        content: "We zoomed in on Facebook Ads, an efficient and cost-effective solution for precise audience targeting. We bypassed SEO, guest blogging, and other time-consuming methods.",
        image: '/images/home-about.webp'
      },
      campaignHighlights: {
        heading: "Campaign Highlights",
        content: [
          {
            point: {
              heading: "Project",
              content: "Properties on Offer:Luxurious 3-5 BHK Villas in Sarjapura"
            }
          },
          {
            point: {
          ...
          },
          {
            point: {
              heading: "Targeting",
              content: "Bengaluru (+27 km radius) 28 - 65 years - Gender : Both male and female"
            }
          },
          {
            point: {
          ...
          },
          {
            point: {
              heading: "Audience",
              content: "Individuals exploring real estate, those in top job roles near Sarjapura, competitor audiences, major corporate entities, users of major real estate platforms, SMEs, etc."
            }
          },
        ]
      },
      adsPresentation: {
        heading: "Ads Presentation",
        images: ['https://res.cloudinary.com/akrdesign/image/upload/v1730207589/growthios/bangalore-market/ads-presentation/01.webp',],
      },
      achievements: {
        heading: "Achievements with Growthios",
        // content: "3 Sales × 58 lakhs (Avg) = 1.75 crores ( 2 Booking got cancelled )",
        image: 'https://res.cloudinary.com/akrdesign/image/upload/v1730270782/growthios/bangalore-market/achievements.webp'
      },
      success: {
        heading: "Evidence of Success",
        content: "This is Growthios' footprint in the Navi Mumbai Real estate market. With the right digital strategy, we turned leads into a whopping 1.50 Crores. Reduced CPL from 715 to 360 and 530 to 430 ₹ in less than 45 days",
