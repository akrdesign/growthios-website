    ...
    <footer className={className}>
      <div className="footer__top__wrapper">
        ...
        <nav>
          <ul>
            <li>
              <Link className="hover-underline-animation-white" href="/">
                Home
              </Link>
            </li>
            <li>
        ...
        <div className="social__links__warpper">
          ...
          <a
            href="https://www.linkedin.com/company/growthios/ "
            target="_blank"
          >
            <LinkedIn />
          </a>
      ...
      <div className="footer__bottom__wrapper">
        ...
        <Link
          className="hover-underline-animation-alto"
          href="/terms-and-conditions"
        >
          Terms and Conditions
        </Link>
        <Link className="hover-underline-animation-alto" href="/privacy-policy">
          Privacy Policy
        </Link>
        <Link className="hover-underline-animation-alto" href="/refund-policy">
          Refund Policy
        </Link>
      </div>
    </footer>
